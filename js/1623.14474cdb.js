/*! For license information please see 1623.14474cdb.js.LICENSE.txt */
"use strict";(self.webpackChunkWeb3_club=self.webpackChunkWeb3_club||[]).push([[1623],{17381:function(e,t,o){var i=o(97199),r=o(25707),s=o(35198),n=o(66312),a=o(64551),c=o(85836).AH`
  :host {
    display: block;
...
`,b=function(e,t,o,i){var r,s=arguments.length,n=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,o,n):r(t,o))||n);return s>3&&n&&Object.defineProperty(t,o,n),n};let f=class extends i.WF{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return i.qy`
    ...
    </wui-flex>`}};f.styles=[w.W5,w.fD,m],b([(0,r.MZ)({type:Array})],f.prototype,"networkImages",void 0),b([(0,r.MZ)()],f.prototype,"text",void 0),f=b([(0,g.E)("wui-compatible-network")],f);o(40289),o(22571),o(46709);var k=o(10152),y=p.AH`
...
`,x=function(e,t,o,i){var r,s=arguments.length,n=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,o,n):r(t,o))||n);return s>3&&n&&Object.defineProperty(t,o,n),n};let v=class extends i.WF{constructor(){super(),this.unsubscribe=[],this.address=n.W.getAccountData()?.address,this.profileName=n.W.getAccountData()?.profileName,this.network=n.W.state.activeCaipNetwork,this.unsubscribe.push(n.W.subscribeChainProp("accountState",e=>{e?(this.address=e.address,this.profileName=e.profileName):a.P.showError("Account not found")}),n.W.subscribeKey("activeCaipNetwork",e=>{e?.id&&(this.network=e)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){if(!this.address)throw new Error("w3m-wallet-receive-view: No account provided");const e=c.$.getNetworkImage(this.network);return i.qy` <wui-flex
    ...
    >
      ...
      .networkImages=${a}
    ></wui-compatible-network>`}onReceiveClick(){u.I.push("WalletCompatibleNetworks")}onCopyClick(){try{this.address&&(h.w.copyToClopboard(this.address),a.P.showSuccess("Address copied"))}catch{a.P.showError("Failed to copy")}}};v.styles=y,x([(0,r.wk)()],v.prototype,"address",void 0),x([(0,r.wk)()],v.prototype,"profileName",void 0),x([(0,r.wk)()],v.prototype,"network",void 0),v=x([(0,p.EM)("w3m-wallet-receive-view")],v)}}]);