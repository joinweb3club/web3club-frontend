"use strict";(self.webpackChunkWeb3_club=self.webpackChunkWeb3_club||[]).push([[6892],{2378:function(t,e,i){var o=i(97199),n=i(25707),r=i(85836),s=i(66312),a=i(64551),l=o.AH`
  :host {
    display: flex;
  }
...
`,c=function(t,e,i,o){var n,r=arguments.length,s=r<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(s=(r<3?n(s):r>3?n(e,i,s):n(e,i))||s);return r>3&&s&&Object.defineProperty(e,i,s),s};let u=class extends o.WF{constructor(){super(...arguments),this.color="primary",this.size="lg"}render(){const t={primary:r.f.tokens.theme.textPrimary,secondary:r.f.tokens.theme.textSecondary,tertiary:r.f.tokens.theme.textTertiary,invert:r.f.tokens.theme.textInvert,error:r.f.tokens.core.textError,warning:r.f.tokens.core.textWarning,"accent-primary":r.f.tokens.core.textAccentPrimary};return this.style.cssText=`\n      --local-color: ${"inherit"===this.color?"inherit":t[this.color]};\n      `,this.dataset.size=this.size,o.qy`<svg viewBox="0 0 16 17" fill="none">
      <path
        ...
        fill="currentColor"
      />
    </svg>`}};u.styles=[s.W5,l],c([(0,n.MZ)()],u.prototype,"color",void 0),c([(0,n.MZ)()],u.prototype,"size",void 0),u=c([(0,a.E)("wui-loading-spinner")],u)},3104:function(t,e,i){i(2378)},45198:function(t,e,i){var o=i(97199),n=i(25707),r=(i(53014),i(67329),i(66312)),s=i(64551),a=i(85836).AH`
  button {
    border: none;
...
`,l=function(t,e,i,o){var n,r=arguments.length,s=r<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(s=(r<3?n(s):r>3?n(e,i,s):n(e,i))||s);return r>3&&s&&Object.defineProperty(e,i,s),s};const c={sm:"sm-medium",md:"md-medium"},u={accent:"accent-primary",secondary:"secondary"};let d=class extends o.WF{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.variant="accent",this.icon=void 0}render(){return o.qy`
    ...
    `}iconTemplate(){return this.icon?o.qy`<wui-icon name=${this.icon} size="sm"></wui-icon>`:null}};d.styles=[r.W5,r.fD,a],l([(0,n.MZ)()],d.prototype,"size",void 0),l([(0,n.MZ)({type:Boolean})],d.prototype,"disabled",void 0),l([(0,n.MZ)()],d.prototype,"variant",void 0),l([(0,n.MZ)()],d.prototype,"icon",void 0),d=l([(0,s.E)("wui-link")],d)},76892:function(t,e,i){i.d(e,{H:function(){return k}});var o=i(97199),n=i(25707),r=i(78508),s=i(36010),a=i(26742),l=i(21871),c=i(26034),u=(i(40289),i(45198),i(3104),i(93511),i(66312)),d=i(30387),p=i(64551),h=i(85836).AH`
  :host {
    position: relative;
...
`,g=function(t,e,i,o){var n,r=arguments.length,s=r<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(s=(r<3?n(s):r>3?n(e,i,s):n(e,i))||s);return r>3&&s&&Object.defineProperty(e,i,s),s};let m=class extends o.WF{constructor(){super(...arguments),this.disabled=!1,this.value=""}render(){return o.qy`<input
      ...
      value=${this.value}
    /> `}};m.styles=[u.W5,u.fD,h],g([(0,n.MZ)({type:Boolean})],m.prototype,"disabled",void 0),g([(0,n.MZ)({type:String})],m.prototype,"value",void 0),m=g([(0,p.E)("wui-input-numeric")],m);var f=o.AH`
  :host {
    position: relative;
    display: block;
  }
...
`,C=function(t,e,i,o){var n,r=arguments.length,s=r<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(s=(r<3?n(s):r>3?n(e,i,s):n(e,i))||s);return r>3&&s&&Object.defineProperty(e,i,s),s};let k=v=class extends o.WF{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){super(),this.loading=!1,this.timeoutTimeLeft=w.Q.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=r.I.state.data?.email,this.authConnector=s.a.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const t=Boolean(this.timeoutTimeLeft),e=this.getFooterLabels(t);return o.qy`
      <wui-flex
    ...
    `}startOTPTimeout(){this.timeoutTimeLeft=w.Q.getTimeToNextEmailLogin(),this.OTPTimeout=setInterval(()=>{this.timeoutTimeLeft>0?this.timeoutTimeLeft=w.Q.getTimeToNextEmailLogin():clearInterval(this.OTPTimeout)},1e3)}async onOtpInputChange(t){try{this.loading||(this.otp=t.detail,this.shouldSubmitOnOtpChange()&&(this.loading=!0,await(this.onOtpSubmit?.(this.otp))))}catch(t){this.error=a.w.parseError(t),this.loading=!1}}async onResendCode(){try{if(this.onOtpResend){if(!this.loading&&!this.timeoutTimeLeft){this.error="",this.otp="";if(!s.a.getAuthConnector()||!this.email)throw new Error("w3m-email-otp-widget: Unable to resend email");this.loading=!0,await this.onOtpResend(this.email),this.startOTPTimeout(),l.P.showSuccess("Code email resent")}}else this.onStartOver&&this.onStartOver()}catch(t){l.P.showError(t)}finally{this.loading=!1}}getFooterLabels(t){return this.onStartOver?{title:"Something wrong?",action:"Try again "+(t?`in ${this.timeoutTimeLeft}s`:"")}:{title:"Didn't receive it?",action:"Resend "+(t?`in ${this.timeoutTimeLeft}s`:"Code")}}shouldSubmitOnOtpChange(){return this.authConnector&&this.otp.length===v.OTP_LENGTH}};k.OTP_LENGTH=6,k.styles=x,C([(0,n.wk)()],k.prototype,"loading",void 0),C([(0,n.wk)()],k.prototype,"timeoutTimeLeft",void 0),C([(0,n.wk)()],k.prototype,"error",void 0),k=v=C([(0,c.EM)("w3m-email-otp-widget")],k)}}]);